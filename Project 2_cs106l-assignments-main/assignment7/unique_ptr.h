...
public:
   ...
   */
  unique_ptr(std::nullptr_t) :address(nullptr){
  ...
  ~unique_ptr() { delete address; };
  unique_ptr(unique_ptr&& other)noexcept : address(other.address) { other.address = nullptr; };
